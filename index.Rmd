...
<img src="https://raw.githubusercontent.com/mrchypark/kisa_finR/master/profile.png" width="100%">
...
빠른 성능으로 개선된 모델인 google의 [word2vec](https://github.com/mukul13/rword2vec)을 시작으로 Stanford에발 발표한 [Glove](https://cran.r-project.org/web/packages/text2vec/vignettes/glove.html), facebook이 발표한 [fastText](https://cran.r-project.org/web/packages/fastTextR/README.html) 등이 있습니다. 우리는 실습이 용이한 Glove를 사용해 보겠습니다.
